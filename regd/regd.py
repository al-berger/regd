...
__lastedited__="2015-06-14 20:03:28"
...
import sys, os, socket, signal, subprocess, logging, argparse, time, regex
...
if logname:
	homedir = os.path.expanduser( '~' + logname )
else:
